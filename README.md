...
We also hypothesized that if D614G increased viral fitness, the average age of symptomatic patients would decrease.
With increased viral fitness conferred by the mutation, younger, typically healthier, patients would be more likely to develop symptomatic infections.
In March, guidelines for testing patients for COVID-19 in Washington included symptoms or exposure to a confirmed COVID-19 infection.
Therefore, many SARS-CoV-2(+) individuals likely had symptomatic infections and a positive SARS-CoV-2 PCR test is an appropriate proxy for symptomatic infection.
...
We compared Ct and age across clade by time and found that early in March, the Ct and age were higher for both clades (Fig. 2). Most of these early infections were by viruses in clade D.

<figure>
	<a id="fig:age-ct-time"></a>
	<img style="width:90%;" src="figures/ct-age-by-week.png" alt="">
  <figcaption>Figure 2: Age and average Ct by clade over time. (A) Violin plots of average Ct by clade over time. Dots represent the mean and bars show two standard deviations from the mean. (B) Horizontal dot plot of age by clade over time. Age was given by decade bin and vertically jittered for visualization.
  </figcaption>
</figure>
...
In this timeframe, the average age of patients with viruses in clade D was 55.6 and the average age was 50.6 of patients with viruses in clade G.
By Student's t-test and Wilcoxon Rank Sum test, these differences in age were significant at p-value's 0.006 and 0.009 respectively (Fig. 3).
...
However, increased viral replication could increase in clinical severity, so we examined the clinical records patients from whom the SARS-CoV-2 samples were collected.
...
Clinical record review was limited to theses patients as the IRB only providing electronic health record access only covered patients in the UW Medicine Network.
Samples were collected from the UW Medicine patients between March 5 and April 1; 77 of these patients were infected with SARS-CoV-2 from clade D, and 75 patients were infected with the clade G virus.
...
|------------|-------------------------|----------------|-----------------|-------------------------|------------------------------------|
| Female: 76 | Range: 11-10 to over 90 | Deceased: 12   | Inpatient: 37   | Yes: 9                  | Yes: 19                            |
...
Again, unlike with all sequences, this difference in age was not significant (Student's t-test: p-value 0.49, Wilcoxon Rank Sum test: p-value 0.51).
However, these p-values are quite large, so it is unlikely that with increased samples we would detect a difference in age for patients with the Spike: D614G mutation.
...
Thus, the absence of an age difference in patients infected with viruses from clade G vs. clade Dc clade in this subset of individuals does not necessarily discount the result from a larger dataset.
...
Not all patients who die from COVID-19 are placed in critical care however; some patients with other advanced health conditions choose to focus on comfort care rather than pursuing aggressive treatment.
Therefore, we lumped patients who died from COVID-19 or who required critical care and performed a Chi-Squared test by clade, and still no found no statistically significant difference across clade (p-value: 0.44).
