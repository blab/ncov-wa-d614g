...
age_time <- df %>%
  ...
  geom_point(aes(color=clade, fill=clade), size=.5) +
  scale_fill_manual(values=c('#0072B2', '#D55E00')) +
  scale_color_manual(values=c('#0072B2', '#D55E00')) +
  theme_minimal() +
  geom_smooth(method="lm", col = "#0072B2", size=1, data = df[df$clade=="D",]) +
  geom_smooth(method="lm", col = "#D55E00", size=1, data = df[df$clade=="G",]) +
  xlab("Date") +
  ylab("Age")
age_time
...
lreg_age <- glm(bin_age ~ clade + week, data = df)
summary(lreg_age)
...
proportion_clade <- plot_clade %>%
  ...
  scale_fill_manual(name = "Clade", labels = c("614G", "614D"), values=c('#D55E00', '#0072B2')) +
  scale_color_manual(name = "Clade", labels = c("614G", "614D"), values=c('#D55E00', '#0072B2')) +
  theme_minimal() +
  ylab("Proportion") +
  xlab("") +
